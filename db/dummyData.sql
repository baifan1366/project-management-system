...
VALUES 
  (
    ...
    FALSE,
    TRUE,
    '{"emailNotifications": true, "pushNotifications": true, "weeklyDigest": true, "mentionNotifications": true, "taskAssignments": true, "taskComments": true, "dueDates": true, "teamInvitations": true}',
    TRUE,
    NULL,
    NULL,
  ...
  (
    ...
    TRUE,
    TRUE,
    '{"emailNotifications": true, "pushNotifications": true, "weeklyDigest": false, "mentionNotifications": true, "taskAssignments": true, "taskComments": true, "dueDates": true, "teamInvitations": true}',
    TRUE,
    NULL,
    NULL,
