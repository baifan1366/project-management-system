    ...
    builder
      ...
      .addCase(fetchPlans.fulfilled, (state, action) => {
        ...
        const monthlyPlans = action.payload.filter(
          plan => plan.billing_interval === 'MONTHLY' || plan.type === 'FREE'
        );
        const yearlyPlans = action.payload.filter(
          plan => plan.billing_interval === 'YEARLY' || plan.type === 'FREE'
        );
        
        state.plans.monthly = monthlyPlans;
        state.plans.yearly = yearlyPlans;
