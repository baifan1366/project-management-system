...
export const fetchTasksBySectionId = createAsyncThunk(
  ...
  async (sectionId) => {
    const res = await api.tasks.listBySectionId(sectionId)
    return res;
  }
)
...
export const fetchTaskById = createAsyncThunk(
  ...
  async (sectionId, taskId) => {
    const res = await api.tasks.getById(sectionId, taskId)
    return res;
  }
)
...
export const createTask = createAsyncThunk(
  'tasks/createTasks',
  async (sectionId, taskData) => {
    const res = await api.tasks.create(sectionId, taskData)
    return res;
  }
)
...
export const updateTask = createAsyncThunk(
  ...
  async ({ sectionId, taskId, taskData }, { rejectWithValue }) => {
    try {
      const res = await api.tasks.update(sectionId, taskId, taskData);
      return res;
    } catch (error) {
...
export const deleteTask = createAsyncThunk(
  'tasks/deleteTask',
  async ({ sectionId, taskId }) => {
    await api.tasks.delete(sectionId, taskId)
    return taskId;
  }
)
