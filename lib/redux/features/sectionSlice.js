...
export const getSectionByTeamId = createAsyncThunk(
    ...
    async (teamId) => {
        const res = await api.sections.getByTeamId(teamId)
        return res;
    }
)
...
export const getSectionById = createAsyncThunk(
    ...
    async (teamId, sectionId) => {
        const res = await api.sections.getById(teamId, sectionId)
        return res;
    }
)
...
export const createSection = createAsyncThunk(
    ...
    async (section, teamId) => {
        const res = await api.sections.create(section, teamId)
        return res;
    }
)
...
export const updateSection = createAsyncThunk(
    ...
    async (section, teamId) => {
        const res = await api.sections.update(section, teamId)
        return res;
    }
)
...
export const deleteSection = createAsyncThunk(
    ...
    async (sectionId, teamId) => {
        const res = await api.sections.delete(sectionId, teamId)
        return res;
    }
)
