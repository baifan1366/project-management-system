    ...
    teamCustomFieldValues: {
      list: async (teamId, teamCustomFieldId) => {
        try {
          ...
          console.log(`调用API获取自定义字段值 [API层], teamId=${teamId}, teamCustomFieldId=${teamCustomFieldId}`);
          ...
          const data = await res.json();
          console.log(`API获取字段值成功, 返回${data.data?.length || 0}条记录`);
          return data;
        } catch (error) {
      ...
      create: async (teamId, teamCustomFieldId, customFieldValueData) => {
        try {
          ...
          console.log(`调用API创建自定义字段值 [API层], teamId=${teamId}, teamCustomFieldId=${teamCustomFieldId}`);
          ...
          const data = await res.json();
          console.log(`API创建字段值成功, id=${data.data?.id || '未知'}`);
          return data;
        } catch (error) {
      ...
      update: async (teamId, teamCustomFieldId, customFieldValueId, customFieldValueData) => {
        try {
          ...
          console.log(`调用API更新自定义字段值 [API层], teamId=${teamId}, teamCustomFieldId=${teamCustomFieldId}, valueId=${customFieldValueId}`);
          ...
          const data = await res.json();
          console.log(`API更新字段值成功, id=${data.data?.id || '未知'}`);
          return data;
        } catch (error) {
      ...
      delete: async (teamId, teamCustomFieldId, customFieldValueId) => {
        try {
          ...
          console.log(`调用API删除自定义字段值 [API层], teamId=${teamId}, teamCustomFieldId=${teamCustomFieldId}, valueId=${customFieldValueId}`);
    ...
    agile: {
      ...
      createSprint: async (sprintData) => {
        try {
          ...
          console.log('【API调用】createSprint, data:', sprintData);
          ...
          const data = await res.json();
          console.log('【API响应】createSprint:', data);
          return { data };
        } catch (error) {
      ...
      startSprint: async (sprintId) => {
        try {
          ...
          console.log('【API调用】startSprint, sprintId:', sprintId);
          ...
          const data = await res.json();
          console.log('【API响应】startSprint:', data);
          return { data };
        } catch (error) {
      ...
      completeSprint: async (sprintId) => {
        try {
          ...
          console.log('【API调用】completeSprint, sprintId:', sprintId);
          ...
          const data = await res.json();
          console.log('【API响应】completeSprint:', data);
          return { data };
        } catch (error) {
      ...
      updateSprint: async (sprintId, sprintData) => {
        try {
          ...
          console.log('【API调用】updateSprint, sprintId:', sprintId, 'data:', sprintData);
          ...
          const data = await res.json();
          console.log('【API响应】updateSprint:', data);
          return { data };
        } catch (error) {
      ...
      createRole: async (roleData) => {
        try {
          ...
          console.log('【API调用】createRole, data:', roleData);
          ...
          const data = await res.json();
          console.log('【API响应】createRole:', data);
          return { data };
        } catch (error) {
      ...
      updateRole: async (roleId, roleData) => {
        try {
          ...
          console.log('【API调用】updateRole, roleId:', roleId, 'data:', roleData);
          ...
          const data = await res.json();
          console.log('【API响应】updateRole:', data);
          return { data };
        } catch (error) {
      ...
      deleteRole: async (roleId) => {
        try {
          ...
          console.log('【API调用】deleteRole, roleId:', roleId);
          const res = await fetchWithTokenRefresh(`${API_BASE}/teams/agile/role/${roleId}`, {
            method: 'DELETE',
            headers: {
              'Content-Type': 'application/json',
          ...
          const data = await res.json();
          console.log('【API响应】deleteRole:', data);
          return { data };
        } catch (error) {
      ...
      assignRole: async (memberData) => {
        try {
          ...
          console.log('【API调用】assignRole, data:', memberData);
          ...
          const data = await res.json();
          console.log('【API响应】assignRole:', data);
          return { data };
        } catch (error) {
      ...
      deleteMember: async (memberId) => {
        try {
          ...
          console.log('【API调用】deleteMember, memberId:', memberId);
          ...
          const data = await res.json();
          console.log('【API响应】deleteMember:', data);
          return { data };
        } catch (error) {
      ...
      addWhatWentWell: async (sprintId, content) => {
        try {
          ...
          console.log('【API调用】addWhatWentWell, sprintId:', sprintId, 'content:', content);
          ...
          const data = await res.json();
          console.log('【API响应】addWhatWentWell:', data);
          return { data };
        } catch (error) {
      ...
      deleteWhatWentWell: async (sprintId, index) => {
        try {
          ...
          console.log('【API调用】deleteWhatWentWell, sprintId:', sprintId, 'index:', index);
          ...
          const data = await res.json();
          console.log('【API响应】deleteWhatWentWell:', data);
          return { data };
        } catch (error) {
      ...
      addToImprove: async (sprintId, content) => {
        try {
          ...
          console.log('【API调用】addToImprove, sprintId:', sprintId, 'content:', content);
          ...
          const data = await res.json();
          console.log('【API响应】addToImprove:', data);
          return { data };
        } catch (error) {
      ...
      deleteToImprove: async (sprintId, index) => {
        try {
          ...
          console.log('【API调用】deleteToImprove, sprintId:', sprintId, 'index:', index);
          ...
          const data = await res.json();
          console.log('【API响应】deleteToImprove:', data);
          return { data };
        } catch (error) {
