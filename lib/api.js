  ...
  teams: {
    ...
    teamCustomFieldValues: {
      list: async (teamId, customFieldId) => {
        const res = await fetchWithTokenRefresh(`${API_BASE}/teams/teamCFValue?teamId=${teamId}&customFieldId=${customFieldId}`)
      ...
      update: async (teamId, customFieldId, customFieldValueId, customFieldValueData) => {
        const res = await fetchWithTokenRefresh(`${API_BASE}/teams/teamCFValue?teamId=${teamId}&customFieldId=${customFieldId}&customFieldValueId=${customFieldValueId}`, {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json',
          },
